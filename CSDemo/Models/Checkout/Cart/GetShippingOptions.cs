...
namespace CSDemo.Models.Checkout.Cart
{
    ...
    public class GetShippingOptions : CommercePipelineProcessor
    {
        ...
        protected virtual void TranslateToShippingOption(Item shippingOptionItem, ShippingOption shippingOption)
        {
            ...
            shippingOption.Name = shippingOptionItem[Constants.KnownFieldNames.Value];
            shippingOption.ShopName = this.GetShopName();
            shippingOption.ShippingOptionType = MainUtil.GetInt(shippingOptionItem[Constants.KnownFieldNames.ShippingOptionValue], 0);
        }
