...
namespace KeefePOC.Repositories
{
	public class DemoFacilityRepository : IFacilityRepository
	{
		...
		{
			DemoFacilities.Add(new Facility() { Name = "CA Hospital Facility 1", ExternalId = "CAHOSP1", AddressLine1 = "123 Fake St", AddressLine2 = "Hopital 1", City = "Santa Ana", State = "CA", Zipcode = "92705", FacilityType = FacilityType.Hospital });
			DemoFacilities.Add(new Facility() { Name = "CA Hospital Facility 2", ExternalId = "CAHOSP2", AddressLine1 = "123 Fake St", AddressLine2 = "Hospital 2", City = "Anytown", State = "CA", Zipcode = "92705", FacilityType = FacilityType.Hospital });
			DemoFacilities.Add(new Facility() { Name = "CA Jail Facility 1", ExternalId = "CAJAIL1", AddressLine1 = "123 Fake St", AddressLine2 = "Jail 1", City = "Anytown", State = "CA", Zipcode = "92705", FacilityType = FacilityType.Jail });
			DemoFacilities.Add(new Facility() { Name = "CA Jail Facility 2", ExternalId = "CAJAIL2", AddressLine1 = "123 Fake St", AddressLine2 = "Jail 2", City = "Anytown", State = "CA", Zipcode = "92705", FacilityType = FacilityType.Jail });
			DemoFacilities.Add(new Facility() { Name = "CA Jail Facility 3", ExternalId = "CAJAIL3", AddressLine1 = "123 Fake St", AddressLine2 = "Jail 3", City = "Anytown", State = "CA", Zipcode = "12345", FacilityType = FacilityType.Jail });
			DemoFacilities.Add(new Facility() { Name = "CA Jail Facility 4", ExternalId = "CAJAIL4", AddressLine1 = "123 Fake St", AddressLine2 = "Jail 4", City = "Anytown", State = "CA", Zipcode = "12345", FacilityType = FacilityType.Jail, ValidateWhitelist = true });
		...
		{
			var match = DemoFacilities.FirstOrDefault(f => f.ExternalId == facilityId);
			if (match == null)
				match = DemoFacilities.First();
